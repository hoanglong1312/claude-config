...
- Codex ghi `ASSUMPTION:` (giả định) vào commit message: `ASSUMPTION: dùng X thay vì Y vì...`
...
4. Sau 3 lần vẫn fail → dừng, ghi `QA-FAIL:` (kiểm thử thất bại) → báo lên (escalate) Claude: `QA-FAIL: [lý do + những gì đã thử]`
